...
export const RenterChatListScreen: React.FC = () => {
  ...
  const handleOpenConversation = (conv: Conversation) => {
    router.push(`/(renter)/chat/${conv.id}`);
  };
      ...
      <View style={styles.searchWrap}>
        <View style={styles.searchBox}>
          ...
          <TextInput
            ...
            placeholder="Search conversations by owner or property..."
        ...
        renderItem={({ item }) => {
          ...
          return (
            <Pressable
              ...
              accessibilityRole="button"
              accessibilityLabel={`Conversation with ${item.owner_name}`}
            >
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySub}>
              Start a conversation with an owner from a property you're interested in.
            </Text>
            <Pressable
