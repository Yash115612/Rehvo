...
export const SEARCH_LANDING_PAGES: Record<string, SearchLandingProfile> = {
  ...
  'affordable-flats-in-powai': {
    ...
    metaDescription: 'Rent budget-friendly verified 1 & 2 BHK flats in Powai near Hiranandani, IIT Bombay, and tech parks. Save 100% on commission fees with REHVO.',
    heading: 'Affordable Flats in Powai, Mumbai',
    subheading: 'Lakeside tech living near Hiranandani Business Park and JVLR with zero agent charges.',
  ...
  'flats-near-metro-station-in-mumbai': {
    ...
    metaDescription: 'Find verified 1, 2, 3 BHK flats within walking distance of Mumbai Metro Lines 1, 2A, 3 & 7. Save hours on your daily commute with Zero Commission.',
  ...
  'pet-friendly-apartments-in-mumbai': {
    ...
    metaDescription: 'Discover verified pet-friendly societies and apartments for rent in Mumbai. Rent with dogs, cats, and pets without RWA restrictions or hidden Commission Fees.',
  ...
  'budget-flats-under-25k-in-mumbai': {
    ...
    metaTitle: 'Budget Flats for Rent Under ₹25,000 in Mumbai | Zero Commission | REHVO',
    metaDescription: 'Verified affordable 1 RK, 1 BHK, and studio flats for rent under ₹25k in Mumbai and suburbs. Zero Commission and low security deposit direct from owners.',
