...
): SupabaseClient => createSupabaseJsClient(url, key);

export const createPublicClient = createServerSupabaseClient;
export const createClient = createServerSupabaseClient;
export const createClientInstance = createServerSupabaseClient;
