  ...
  return (
    <section className="py-12 sm:py-16 bg-[#F8FAFC]">
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-[#031B2A] via-[#064E3B] to-[#0F766E] rounded-[32px] p-8 sm:p-12 text-white shadow-card-hover relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-4">
                <Link
                  href="/ai-concierge"
                  className="h-12 px-7 rounded-full bg-[#CCFBF1] hover:bg-white text-[#064E3B] text-xs font-black flex items-center gap-2 shadow-lg transition-all duration-200"
                >
                ...
                <div className="flex items-center gap-2 text-xs font-bold text-[#CCFBF1]/80">
            ...
            <div className="lg:col-span-5 space-y-3">
              {/* User Bubble */}
              <div className="bg-white/10 backdrop-blur-md rounded-2xl rounded-tr-none p-4 border border-white/15 ml-auto max-w-sm space-y-1">
              ...
              {/* AI Bubble */}
              <div className="bg-[#031B2A]/80 backdrop-blur-lg rounded-2xl rounded-tl-none p-4 border border-teal-500/30 max-w-sm space-y-2">
                ...
                <div className="pt-1 flex items-center gap-2 text-[10px] font-bold text-[#CCFBF1]">
