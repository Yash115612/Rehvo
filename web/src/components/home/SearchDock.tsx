...
export const SearchDock: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 sm:-mt-14 relative z-30">
      {/* Floating Category Segmented Tabs */}
      <div className="flex flex-wrap items-center gap-1.5 p-1.5 bg-stone-900/85 backdrop-blur-2xl rounded-2xl w-fit mb-3.5 border border-white/15 shadow-2xl">
        {[
      ...
      <form
        ...
        className="bg-white/95 backdrop-blur-2xl rounded-3xl sm:rounded-[28px] p-3 sm:p-4 border border-stone-200/90 shadow-2xl shadow-stone-950/20 grid grid-cols-1 md:grid-cols-12 gap-3 items-center"
      >
        {/* Input 1: Location Autocomplete */}
        <div className="md:col-span-5 relative pr-0 md:pr-3 border-b md:border-b-0 md:border-r border-stone-200/80 pb-2.5 md:pb-0">
        ...
        <div className="md:col-span-3 pr-0 md:pr-3 border-b md:border-b-0 md:border-r border-stone-200/80 pb-2.5 md:pb-0">
          <label className="block text-[10px] font-extrabold uppercase tracking-widest text-stone-400 pl-3 mb-0.5">
            I&apos;m looking for
          </label>
          <select
