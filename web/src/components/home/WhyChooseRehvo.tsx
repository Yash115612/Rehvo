...
export const WhyChooseRehvo: React.FC = () => {
  return (
    <section className="bg-[#F8FAFC] py-12 sm:py-16 border-b border-stone-200/60">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8">
        <div className="bg-[#CCFBF1] rounded-3xl p-6 sm:p-8 border border-[#99F6E4]/60 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          {/* Left Heading (3 Cols) */}
          <div className="lg:col-span-3">
            <h2 className="text-xl sm:text-2xl font-extrabold text-stone-900 leading-tight">
              ...
              <span className="text-[#0F766E]">REHVO?</span>
            </h2>
          </div>
          ...
          <div className="lg:col-span-9 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full bg-white text-[#0F766E] flex items-center justify-center flex-shrink-0 shadow-sm mt-0.5">
